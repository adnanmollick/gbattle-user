...
function AppInner() {
  ...
  return (
    <div className="app-outer">
      <div className="app-shell" style={{ background:"#06040f", minHeight:"100vh", color:"#f5f3ff", position:"relative", contain:"layout" }}>
      <SEOManager />
      <ParticleBackground />
            ...
            <>
              ...
              <div className="page-enter" style={{ paddingBottom: page==="detail"?20:80 }}>
                <Suspense fallback={<PageSkeleton />}>
                  {page==="home"        && <HomePage onNavigate={navigate} onCategoryClick={handleCategoryClick} onMatchClick={goToMatch} />}
