      ...
      <div style={{ position:"sticky", top:0, zIndex:50, background:"rgba(6,4,15,0.8)", backdropFilter:"blur(20px)", WebkitBackdropFilter:"blur(20px)", borderBottom:"1px solid rgba(167,139,250,0.1)", padding:"12px 18px", display:"flex", alignItems:"center", justifyContent:"space-between" }}>
        {isDetail ? (
          ...
          <div style={{ display:"flex", alignItems:"center", gap:10 }}>
            <div style={{ width:34, height:34, borderRadius:10, background:"linear-gradient(135deg,#7c3aed,#a78bfa)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:16, boxShadow:"0 0 16px rgba(124,58,237,0.5)" }}>⚡</div>
            <span style={{ fontFamily:"Orbitron,sans-serif", fontSize:16, fontWeight:900, color:"#fff", letterSpacing:1 }}>G-BATTLE</span>
          </div>
        )}
