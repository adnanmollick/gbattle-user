  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      await setDoc(doc(db,"users",cred.user.uid), {
        ...
        email, wallet:0, totalWins:0, totalMatches:0, totalEarned:0,
    ...
    try {
      ...
      if (!snap.exists()) {
        ...
        await setDoc(userRef, {
          ...
          email:result.user.email, wallet:0, totalWins:0, totalMatches:0, totalEarned:0,
    ...
    <div style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", padding:20, background:"#06040f", position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ width:"100%", maxWidth:380, position:"relative", zIndex:1 }}>
        ...
        <div style={{ textAlign:"center", marginBottom:32 }}>
          <div style={{ fontFamily:"Orbitron,sans-serif", fontSize:38, fontWeight:900, letterSpacing:3, background:"linear-gradient(90deg,#a78bfa,#fff,#7c3aed)", backgroundSize:"200% auto", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", textShadow:"0 0 30px rgba(124,58,237,0.6)", animation:"logoShine 3s linear infinite", marginBottom:8 }}>G-BATTLE</div>
